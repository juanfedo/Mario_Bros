...
public class _RandomGoomba : _ACElement
{
    ...
    {
        int length = 210;
        int prob_from_main = 10;//(_Parameters.Ground_prob == null || _Parameters.Goomba_prob.Trim() == string.Empty) ? 10 : int.Parse(_Parameters.Goomba_prob);
